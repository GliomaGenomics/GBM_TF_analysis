...
NES_data$Cohort <- ifelse(grepl('\\.', NES_data$Cohort), 'Validation', 'Discovery')
FDR_data$Cohort <- ifelse(grepl('\\.', FDR_data$Cohort), 'Validation', 'Discovery')
...
NES_data$Cohort<- relevel(NES_data$Cohort, "Discovery")
FDR_data$Cohort<- relevel(FDR_data$Cohort, "Discovery")
